...
<head>
    ...
    <title>Panel - {{ Auth::user()->role }}</title>
        ...
        <div class="main-panel">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                <p class="card-category">Cuti/Sakit/Izin</p>
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    <div class="copyright">
                        &copy; 2024, hak cipta <i class="fa fa-heart heart text-danger"></i> oleh <b>Kelompok 4</b>
                    </div>
                </div>
            </footer>
        </div>
